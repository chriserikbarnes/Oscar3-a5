...
public class CompareSubtypes {
	...
	public static String convertSubtype(String subtype) {
		...
		//if(subtype.equals("DESC")) return "OTHER";
	...
	public static void main(String[] args) throws Exception {
		...
		for(int fi=0;fi<fn.length;fi++) {
			...
			if(m.matches()) {
				...
				Set<String> toOtherSet = new HashSet<String>(StringTools.arrayToList(new String []{"fragment", "yield", "fragments", "yields", "bridge", "bridges", "anchor", "anchors",
						"bridging", "bridged", "attached", "linked"}));
				//}));
				...
				for(int i=0;i<n1.size();i++) {
					...
					/*if(toOtherSet.contains(e1.getValue().toLowerCase())) {
						st1 = "OTHER";
						st2 = "OTHER";
					}*/
					
					//if("protonated".equals(e1.getValue().toLowerCase()) || "protonation".equals(e1.getValue().toLowerCase())) {
					//	st1 = "DESC";
					//	st2 = "DESC";						
					//}

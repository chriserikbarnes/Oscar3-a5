		...
		<div class="sentencearea">
			...
			<div class="dropdowns">
				...
				<xsl:when test="annotationART">
					<select class="type" onchange="changeType(this,true)">
						...
						<option class="Bac" value="Bac" ><xsl:if test="annotationART[@type = 'Bac']">
								<xsl:attribute name="selected">selected</xsl:attribute>
							</xsl:if>Background</option>
						<option class="Con" value="Con" ><xsl:if test="annotationART[@type = 'Con']">
								<xsl:attribute name="selected">selected</xsl:attribute>
							</xsl:if>Conclusion</option>
							<!-- Removing "Example" -->
						<!-- <option class="Exa" value="Exa" ><xsl:if test="annotationART[@type = 'Exa']">
								<xsl:attribute name="selected">selected</xsl:attribute>
							</xsl:if>Example</option>-->
						<option class="Exp" value="Exp" ><xsl:if test="annotationART[@type = 'Exp']">
								<xsl:attribute name="selected">selected</xsl:attribute>
							</xsl:if>Experiment</option>
						<option class="Goa" value="Goa" ><xsl:if test="annotationART[@type = 'Goa']">
								<xsl:attribute name="selected">selected</xsl:attribute>
							</xsl:if>Goal</option>
						<option class="Hyp" value="Hyp" ><xsl:if test="annotationART[@type = 'Hyp']">
								<xsl:attribute name="selected">selected</xsl:attribute>
							</xsl:if>Hypothesis</option>
						<option class="Met" value="Met">
							<xsl:if test="annotationART[@type = 'Met']">
								<xsl:attribute name="selected">selected</xsl:attribute>
							</xsl:if>Method</option>
						<option class="Mod" value="Mod" ><xsl:if test="annotationART[@type = 'Mod']">
								<xsl:attribute name="selected">selected</xsl:attribute>
							</xsl:if>Model</option>
						<option class="Mot" value="Mot" ><xsl:if test="annotationART[@type = 'Mot']">
								<xsl:attribute name="selected">selected</xsl:attribute>
							</xsl:if>Motivation</option>
						<option class="Obj" value="Obj" ><xsl:if test="annotationART[@type = 'Obj']">
								<xsl:attribute name="selected">selected</xsl:attribute>
							</xsl:if>Object</option>
						<option class="Obs" value="Obs" ><xsl:if test="annotationART[@type = 'Obs']">
								<xsl:attribute name="selected">selected</xsl:attribute>
							</xsl:if>Observation</option>
							<!-- Removing "Problem" -->
						<!--  <option class="Pro" value="Pro" ><xsl:if test="annotationART[@type = 'Pro']">
								<xsl:attribute name="selected">selected</xsl:attribute>
							</xsl:if>Problem</option>-->
						<option class="Res" value="Res" ><xsl:if test="annotationART[@type = 'Res']">
								<xsl:attribute name="selected">selected</xsl:attribute>

...
public final class NETypes {
	...
	private static ResourceGetter rg = new ResourceGetter("uk/ac/cam/ch/wwmm/oscar3/misc/resources/");
	private static NETypes myInstance;
	...
	private static NETypes getInstance() {
		try {
			if(myInstance == null) myInstance = new NETypes();
			return myInstance;
		} catch (Exception e) {
			e.printStackTrace();
	...
	private NETypes() throws Exception {

...
public class EntityFVE extends FeatureVectorExtractor {

	Map<String, Bag<String>> featureVectors;
	Bag<String> features;
	Bag<String> terms;
	
	public EntityFVE(List<File> files) throws Exception {
		...
		for(File f : files) {
			...
			for(String e : entities) {
				...
				for(String entFeature : entities) {
					if(entFeature.equals(e)) continue;
					features.add(entFeature);
					featureVectors.get(e).add(entFeature);
				}
			}
